    ...
    <div className="shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <button className="ring ring-gray-300 shadow-lg rounded-md px-2 py-1 text-sm cursor-pointer hover:text-white hover:bg-black transition-all duration-300 flex items-center gap-2">
